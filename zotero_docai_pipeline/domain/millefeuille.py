...
class TagState(_StringEnum):
    SELECTED = "docai"
    PREVIEWED = "docai-previewed"
    HANDOFF_EXPORTED = "docai-handoff-exported"
    SOURCE_VERIFIED = "docai-source-verified"
    SOURCE_PACKED = "docai-source-packed"
    EXTRACTED_NATIVE = "docai-extracted-native"
    EXTRACTED_OCR = "docai-extracted-ocr"
    OPENKB_ADDED = "docai-openkb-added"
    ACCEPTANCE_PASSED = "docai-acceptance-passed"
    READY_FOR_CLASSIFICATION = "docai-ready-for-classification"
    CLASSIFIED = "docai-classified"
    NEEDS_REVIEW = "docai-needs-review"
    ERROR = "docai-error"
