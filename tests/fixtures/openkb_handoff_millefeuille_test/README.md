# millefeuille-test OpenKB Handoff Fixture

Offline, redacted fixture derived from the June 2, 2026 `millefeuille-test` Zotero
dogfood run.
...
- duplicate-scan evidence for the three imports, represented in
  `duplicate_scans.jsonl`.
...
preview-redaction, downstream OpenKB outcome, duplicate-scan, and acceptance
summary shape needed for repeatable tests.
