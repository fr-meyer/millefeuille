"""Acceptance checks for the redacted millefeuille-test OpenKB handoff fixture."""
...
class TestMillefeuilleTestOpenKBHandoffFixture(unittest.TestCase):
    def test_live_fixture_rows_are_full_verified_and_secret_safe(self):
        ...
        for row in rows:
            ...
            self.assertEqual(row["schema_version"], "openkb-millefeuille-handoff/v0.1")
