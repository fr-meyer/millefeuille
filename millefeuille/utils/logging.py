"""Logging utilities for the Millefeuille.
...
from millefeuille.domain.config import OCRProviderConfig, PageIndexOCRConfig
...
def log_startup(logger: logging.Logger, message: str) -> None:
    ...
    Example:
        >>> logger = logging.getLogger(__name__)
        >>> log_startup(logger, "Starting Millefeuille")
        # Output: "🚀 Starting Millefeuille" or "[START] Starting
        # Millefeuille"
    """
...
def log_tagging(logger: logging.Logger, tag_name: str) -> None:
    ...
    Example:
        >>> logger = logging.getLogger(__name__)
        >>> log_tagging(logger, "millefeuille-processed")
        # Output: "🏷️ Added tag: millefeuille-processed"
        # or "[TAG] Added tag: millefeuille-processed"
    """
