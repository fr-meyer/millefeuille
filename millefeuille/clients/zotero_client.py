...
from millefeuille.domain.markdown_converter import convert_markdown_to_html
...
class ZoteroClient:
    ...
    for the Millefeuille, including tag-based item retrieval,
    PDF downloads, batch note creation, and tag management.

    Example:
        >>> from millefeuille.domain.config import AuthQueryConfig
        ...
        >>> items = client.get_items_by_tag("millefeuille", "millefeuille-processed")
    """
